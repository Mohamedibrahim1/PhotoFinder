...
public class DetailActivity extends Activity {
    private DetailActivity DInstance = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FetchOwnerTask OwnerTask = new FetchOwnerTask();
        OwnerTask.execute();
    }

    public class FetchOwnerTask extends AsyncTask<String, Void, String[]> {
        ...
        final String OWNER_ID_PARAM = "&user_id=";
        ...
        final String url = BASE_URL + KEY_PARAM + key + METHOD_PARAM + method + FORMAT_PARAM + format + PER_PAGE_PARAM + per_page + OWNER_ID_PARAM + owner;
        final List<PhotoItem> rowItems = new ArrayList<PhotoItem>();
        final ListView listView = (ListView) findViewById(R.id.listUser);
        RequestQueue queue = Volley.newRequestQueue(DInstance);
